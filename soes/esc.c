 ...
 */
/* Global varliables used by the stack */
esc_cfg_t * esc_cfg = NULL;
size_t ESC_MBXSIZE;
unsigned int ESC_MBX0_sma;
unsigned int ESC_MBX0_sml;
unsigned int ESC_MBX0_sme;
unsigned int ESC_MBX0_smc;
unsigned int ESC_MBX1_sma;
unsigned int ESC_MBX1_sml;
unsigned int ESC_MBX1_sme;
unsigned int ESC_MBX1_smc;
...
{
   /* Assign SM settings */
   ESC_MBXSIZE = ESC_MBXSIZE_s;
   ESC_MBX0_sma = ESC_MBX0_sma_s;
   ESC_MBX0_sml = ESC_MBX0_sml_s;
   ESC_MBX0_sme = ESC_MBX0_sme_s;
   ESC_MBX0_smc = ESC_MBX0_smc_s;
   ESC_MBX1_sma = ESC_MBX1_sma_s;
   ESC_MBX1_sml = ESC_MBX1_sml_s;
   ESC_MBX1_sme = ESC_MBX1_sme_s;
   ESC_MBX1_smc = ESC_MBX1_smc_s;
...
{
   /* Assign SM settings */
   ESC_MBXSIZE = ESC_MBXSIZE_b;
   ESC_MBX0_sma = ESC_MBX0_sma_b;
   ESC_MBX0_sml = ESC_MBX0_sml_b;
   ESC_MBX0_sme = ESC_MBX0_sme_b;
   ESC_MBX0_smc = ESC_MBX0_smc_b;
   ESC_MBX1_sma = ESC_MBX1_sma_b;
   ESC_MBX1_sml = ESC_MBX1_sml_b;
   ESC_MBX1_sme = ESC_MBX1_sme_b;
   ESC_MBX1_smc = ESC_MBX1_smc_b;
...
void ESC_readmbx (void)
{
   ...
   ESC_read (ESC_MBX0_sma, MBh, ESC_MBXHSIZE);
   ...
   ESC_read (ESC_MBX0_sma + ESC_MBXHSIZE, (MBX + ESC_MBXHSIZE), length);
